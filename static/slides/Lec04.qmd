...
3. and a link function $g$ such that $g(E(\boldsymbol{Y}|\boldsymbol{X})) = \boldsymbol{\eta}$.
...
Deviance is a way of measuring the difference between a GLM's fit and the fit of the perfect model (i.e. where $E(\hat{Y}_i|X) = Y_i$).
