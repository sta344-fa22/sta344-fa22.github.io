...
ll_gp = gpglm(
  ...
  starting = list(
    beta=rep(0,7), phi=3, sigma.sq=1, w=0
  ),
  priors = list(phi.unif=c(3/4, 3/0.1), sigma.sq.ig=c(2, 2)),
  tuning = list(
    "beta"=c(0.05,0.3,0.0001,0.0003,0.0005,0.1,0.07), 
