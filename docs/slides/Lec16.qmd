...
::: {.small}
```{r cache=TRUE}
#| code-line-numbers: "|2|3|4-6|7-8|10-14|15-17"
m = gplm(
...
![](imgs/bda_cover.png){fig-align="center" width="40%"}
...
:::: {.columns}
::: {.column width='50%'}
![](imgs/births_pic1.png){fig-align="center" width="100%"}
:::
...
![](imgs/Lec16/fit.png){fig-align="center" width="100%"}


## Fit Components

![](imgs/Lec16/fit_decomposition.png){fig-align="center" width="100%"}


## Model fit + forecast

![](imgs/Lec16/fit_forecast.png){fig-align="center" width="100%"}


## Forecast

![](imgs/Lec16/forecast_zoom.png){fig-align="center" width="100%"}


## Forecast components

![](imgs/Lec16/forecast_decomp.png){fig-align="center" width="100%"}

## ARIMA forecast

![](imgs/Lec16/forecast_arima.png){fig-align="center" width="100%"}
