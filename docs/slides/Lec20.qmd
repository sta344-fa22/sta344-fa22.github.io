...
```{r echo=FALSE}
( ggplot(data = nc) + geom_abline(intercept=0, slope=1, color="lightgrey") + geom_point(aes(x=1000*SID74/BIR74, y=car_pred)) ) / 
( ggplot(data = nc) + geom_abline(intercept=0, slope=1, color="lightgrey") + geom_point(aes(x=1000*SID74/BIR74, y=sar_pred)) ) 
```
